...
class WeeklyTrendingTv extends GetResponsiveView {
  WeeklyTrendingTv({Key? key}) : super(key: key);
  ...
  Widget? builder() {
    return Container(
      ...
      child: Obx(
        () => ListView.separated(
          key: const PageStorageKey<String>('weeklyTrendingTv'),
          scrollDirection: Axis.horizontal,
          itemCount: pageController.weeklyTrendingsTv.length,
            ...
            () => Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      fit: BoxFit.cover,
                      image: NetworkImage(
                          'https://image.tmdb.org/t/p/w500${pageController.weeklyTrendingsTv[index].posterPath}'))),
              child: Material(
                ...
                child: InkWell(
                  onTap: () {
                    Get.to(
                      ...
                      arguments: [
                        {
                          'id': pageController.weeklyTrendingsTv[index].id!,
                          'isMovie': false,
                        }
                      ],
                    );
                    ...
                    children: [
                      BackgroundCircle(
                        voteAverage: (pageController
                            .weeklyTrendingsTv[index].voteAverage),
                      ),
                      Positioned(
                          bottom: 0,
                          right: 0,
