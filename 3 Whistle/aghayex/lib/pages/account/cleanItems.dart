...
class cleanItems extends StatefulWidget {
  @override
  _cleanItemsState createState() => _cleanItemsState();
}

class _cleanItemsState extends State<cleanItems>
    with AutomaticKeepAliveClientMixin<cleanItems> {
