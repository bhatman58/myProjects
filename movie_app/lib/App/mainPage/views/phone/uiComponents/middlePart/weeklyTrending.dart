...
class WeeklyTrending extends GetResponsiveView {
  WeeklyTrending({Key? key}) : super(key: key);
  ...
  Widget? builder() {
    return Container(
      ...
      child: Obx(
        () => ListView.separated(
          key: const PageStorageKey<String>('weeklyListview'),
          scrollDirection: Axis.horizontal,
          itemCount: pageController.weeklyTrendings.length,
            ...
            () => Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      fit: BoxFit.cover,
                      image: NetworkImage(
                          'https://image.tmdb.org/t/p/w500${pageController.weeklyTrendings[index].posterPath}'))),
              child: Material(
                ...
                child: InkWell(
                  onTap: () {
                    Get.to(
                      ...
                      arguments: [
                        {
                          'id': pageController.weeklyTrendings[index].id!,
                          'isMovie': true,
                        }
                      ],
                    );
                  ...
                  child: Stack(
                    children: [
                      BackgroundCircle(
                        voteAverage:
                            (pageController.weeklyTrendings[index].voteAverage),
                      ),
                      Positioned(
                          bottom: 0,
                          right: 0,
