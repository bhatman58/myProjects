...
import 'package:movie_app/App/mainPage/views/phone/uiComponents/middlePart/dailyTrending.dart';
import 'package:movie_app/App/mainPage/views/phone/uiComponents/middlePart/weeklyTrending.dart';
import 'package:movie_app/App/utils/appColors.dart';

class MainPagePhoneMiddlePart extends GetResponsiveView {
  MainPagePhoneMiddlePart({Key? key}) : super(key: key);
            ...
            children: [
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: TabBar(
                          onTap: (ind) {
                            if (ind == 0 &&
                                pageController.dailyTrendings.isEmpty) {
                              print('daily was empty , called method');
                              pageController.getTrendingMainPage('day');
                            } else if (ind == 1 &&
                                pageController.weeklyTrendings.isEmpty) {
                              print('week empty ');
                              pageController.getTrendingMainPage('week');
                            }
                            // ind == 0
                            //     ? pageController.getTrendingMainPage('day')
                            //     : pageController.getTrendingMainPage('week');
                          ...
                          controller: pageController.tController,
              ...
              Expanded(
                  child: TabBarView(
                      physics: const NeverScrollableScrollPhysics(),
                      controller: pageController.tController,
                      children: [DailyTrending(), WeeklyTrending()]))
            ],
          )),
    );
  }
