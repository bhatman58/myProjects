...
class DailyTrending extends GetResponsiveView {
  DailyTrending({Key? key}) : super(key: key);
    ...
    return Container(
      ...
      child: Obx(
        () => ListView.separated(
          ...
          itemCount: pageController.dailyTrendings.length,
            ...
            () => Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      fit: BoxFit.cover,
                      image: NetworkImage(
                          'https://image.tmdb.org/t/p/w500${pageController.dailyTrendings[index].posterPath}'))),
              child: Material(
                ...
                child: InkWell(
                  onTap: () {
                    Get.to(
                      ...
                      arguments: [
                        {
                          'id': pageController.dailyTrendings[index].id!,
                          'isMovie': true,
                        }
                      ],
                    );
                  ...
                  child: Stack(
                    children: [
                      BackgroundCircle(
                        voteAverage:
                            (pageController.dailyTrendings[index].voteAverage),
                      ),
                      Positioned(
                          bottom: 0,
                          right: 0,
